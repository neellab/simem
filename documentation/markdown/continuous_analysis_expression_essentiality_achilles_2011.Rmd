...
The formatted CCLE microarray-based expression data for these genes can be downloaded [__HERE__](https://github.com/neellab/bfg/blob/gh-pages/data/expression/ccle_achilles_expression.txt.zip?raw=true).
