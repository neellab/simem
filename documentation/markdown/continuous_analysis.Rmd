...
The breast RNA-Seq expression file, from which we'll extract CCND1 log2-FPKM expression values, can be downloaded [__HERE__](https://github.com/neellab/bfg/blob/gh-pages/data/rnaseq/breast_rnaseq_qn.txt.zip?raw=true).
