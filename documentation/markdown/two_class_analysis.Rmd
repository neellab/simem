Two-Class Differential Essentiality Analysis
-------------------------------------------------------------


First [download the simem R code](https://neellab.github.io/simem/). 
&nbsp;
...
The breast cell line subtypes table detailing the classes we want to compare for differential essentiality can be downloaded [here](https://github.com/neellab/bfg/blob/gh-pages/data/annotations/cell_line_subtypes.txt.zip?raw=true).
